...
with sharedmem.Pool() as pool:
     def work(slice):
         ...
         hij,hr = ed_corr_allsg(seCent,seeigvec,sDcent,rpbins,si1,sj1,boxlen)
         if ((censatbool == 1) | ((censatbool == 0) & (minmaxbool == 1))):
            hij.tofile('/home/EEEDdata_alltracer/' + rdstr2 + '_'+ str(Dlen) + 'ed' + clrstr1 + '.' + dirno + '.' + str(mmin) + '.' + str(mmax) + '.' + str(si1) + str(sj1) + typ1 + '.alltracer')
            hr.tofile('/home/EEEDdata_alltracer/' + rdstr2 + '_'+ str(Dlen) + 'rhisted' + clrstr1 + '.' + dirno + '.' + str(mmin) + '.' + str(mmax) + '.' + str(si1) + str(sj1) + typ1 + '.alltracer')             
