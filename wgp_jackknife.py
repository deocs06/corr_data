...
for jki in range(gini_ij,gfin_ij):
      ...
      jklen.tofile('/home/wgpdata_errors/' + rdstr2 + '_'+ str(Dlen) + 'jklen5' + '.' + str(jki) + clrstr1 + str_nsubl  + '.' + dirno + '.' + str(mmin) + '.' + typ1 + '.alltracer')
      ...
      with sharedmem.Pool() as pool:
           def work(slice):
               ...
               hij1 = wgp_shapcorr(seCent,seeigvec,sq,sDcent,rpbins,zpbins,si1,sj1,boxlen)
               print [jki,1]
               hij2 = wgp_shapcorr(seCent,seeigvec,sq,sRcent,rpbins,zpbins,si1,sj1,boxlen)
               print [jki,2]
               
               (hij1[0]).tofile('/home/wgpdata_errors/' + rdstr2 + '_'+ str(Dlen) + 'SpD' + '.' + str(jki) + clrstr1 + str_nsubl  + '.' + dirno + '.' + str(mmin) + '.' + str(si1) + str(sj1) + typ1 + '.alltracer')
               (hij2[0]).tofile('/home/wgpdata_errors/' + rdstr2 + '_'+ str(Dlen) + 'SpR' + '.' + str(jki) + clrstr1 + str_nsubl  + '.' + dirno + '.' + str(mmin) + '.' + str(si1) + str(sj1) + typ1 + '.alltracer')
